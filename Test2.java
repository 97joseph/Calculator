...
public class Scientific_Calc extends JFrame implements ActionListener {
JTextField tf;
double tem_1, tem_11, ans, a1;
static double m_1, m_2;
int k1 = 1, x1 = 0, y1 = 0, z1 = 0;
char ch;
JButton button1, button2, button3, button4, button5, button6, button7, button8, button9, zero_val, clr_val, power2, power3, expression,
factorial, add, minius, divide, log, recep, multiply, equa, add_sub, dot, m_r, m_c, m_p,
m_m, sqrtval, sinval, cosval, tanval;
Container cont1;
...
m_r = new JButton("MR");
b_panel.add(m_r);
m_r.addActionListener(this);
m_c = new JButton("C");
b_panel.add(m_c);
m_c.addActionListener(this);

m_p = new JButton("M+");
b_panel.add(m_p);
m_p.addActionListener(this);
...
sqrtval = new JButton("SQRT");
b_panel.add(sqrtval);
sqrtval.addActionListener(this);
log = new JButton("log");
b_panel.add(log);
log.addActionListener(this);

sinval = new JButton("SIN");
b_panel.add(sinval);
sinval.addActionListener(this);
cosval = new JButton("COS");
b_panel.add(cosval);
cosval.addActionListener(this);
tanval = new JButton("TAN");
b_panel.add(tanval);
tanval.addActionListener(this);
power2 = new JButton("x^2");
b_panel.add(power2);
power2.addActionListener(this);
power3 = new JButton("x^3");
b_panel.add(power3);
...
clr_val = new JButton("AC");
b_panel.add(clr_val);
clr_val.addActionListener(this);
...
Scientific_Calc f1= new Scientific_Calc();
f1.setTitle("Scientific_Calc");
f1.pack();
f1.setVisible(true);
}
}
